...
m_weighted = CategoryMetric(100, ["A", "B", "C"], [0.5, 0.3, 0.2]; weight=2.5)
@test m_weighted.weight == 2.5
@test isapprox(mismatch(["A", "A", "A", "A", "A", "A"], m_weighted), 15.0)
...
@test_throws ArgumentError CategoryMetric(100, ["A", "B", "C"], [0.5, 0.3, 0.2]; weight=-1.0) # negative weight
